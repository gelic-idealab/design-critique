...
# Tilt Brush Module Instructions
...
4. Draw your sketch
5. Save your sketch (TILT file) to computer
6. Export your model (GLB file) to computer
7. Understand the difference between sketch files and model files
8. Ensure your sketch and model are backed up in Google Drive
...
## Draw and save your sketch (TILT file) to the computer
